...
import "./network.scss";
import perfil from "../network/photo desktop cielo.png";
import ContactUs from "./form/form.js";
    ...
    <>
      ...
      <section className="section-social">
        <div className="social-photo">
          <img src={perfil} alt="Cielo Rodriguez " />
        </div>
        ...
        <div className="section-contact">
          ...
          <div className="container-wattsap">
            <a
              ...
              href="https://api.whatsapp.com/send?phone=595983430478"
              target="_black"
            >
